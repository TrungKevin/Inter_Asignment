...
@Component("sendCounterProposalMailDelegate")
@RequiredArgsConstructor
//•	Gửi mail Counter Proposal
public class SendCounterProposalMailDelegate implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) {
    ...
    notificationService.sendCounterProposalNotification(requestId, comment);
  }
}
