...
function requireDocument() {
  ...
  Document2.prototype = Object.create(ContainerNode.prototype, {
    ...
    createTreeWalker: { value: function(root3, whatToShow, filter2) {
      if (!root3) {
    ...
    createNodeIterator: { value: function(root3, whatToShow, filter2) {
      if (!root3) {
        throw new TypeError("root argument is required");
      }
      if (!(root3 instanceof Node2)) {
...
var ServerXhr = class _ServerXhr {
  ...
  async \u0275loadImpl() {
    if (!this.xhrImpl) {
      const {
        default: xhr
      } = await import("./chunk-2N4ZL7DF.mjs");
      this.xhrImpl = xhr;
    }
  }
  build() {
...
function extractRoutesAndCreateRouteTree(options) {
  ...
  async function extract() {
    ...
    const bootstrap2 = await manifest2.bootstrap();
    const {
      baseHref,
      appShellRoute,
      routes: routes2,
      errors
    } = await getRoutesFromAngularRouterConfig(bootstrap2, document2, url, invokeGetPrerenderParams, includePrerenderFallbackRoutes, manifest2.entryPointToBrowserMapping);
...
var MatToolbar = class _MatToolbar {
  ...
  _checkToolbarMixedModes() {
    if (this._toolbarRows.length && (typeof ngDevMode === "undefined" || ngDevMode)) {
      const isCombinedUsage = Array.from(this._elementRef.nativeElement.childNodes).filter((node2) => !(node2.classList && node2.classList.contains("mat-toolbar-row"))).filter((node2) => node2.nodeType !== (this._document ? this._document.COMMENT_NODE : 8)).some((node2) => !!(node2.textContent && node2.textContent.trim()));
      if (isCombinedUsage) {
...
var routes = [
  __spreadValues({
    path: "login",
    loadComponent: () => import("./chunk-YEZBJMR6.mjs").then((m) => m.Login)
  }, true ? { \u0275entryName: "src/login/login.ts" } : {}),
  __spreadValues({
    path: "register",
    loadComponent: () => import("./chunk-SCRHUZWX.mjs").then((m) => m.Register)
  }, true ? { \u0275entryName: "src/register/register.ts" } : {}),
  // (removed) reset-password route
  __spreadValues({
    path: "home",
    loadComponent: () => import("./chunk-HKHZ5NZK.mjs").then((m) => m.Home),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/home/home.ts" } : {}),
  __spreadValues({
    path: "profile",
    loadComponent: () => import("./chunk-UJAMQ7P2.mjs").then((m) => m.Profile),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/profile/profile.ts" } : {}),
  __spreadValues({
    path: "admin",
    loadComponent: () => import("./chunk-HB4BI4VS.mjs").then((m) => m.AdminPanel),
    canActivate: [authGuard, adminGuard]
  }, true ? { \u0275entryName: "src/admin/admin-panel.ts" } : {}),
  __spreadValues({
    path: "access-requests/create",
    loadComponent: () => import("./chunk-4DZ3HNYX.mjs").then((m) => m.CreateAccessRequest),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/access-request/create-request/create-request.ts" } : {}),
  __spreadValues({
    path: "access-requests/mine",
    loadComponent: () => import("./chunk-BSVJ3DLI.mjs").then((m) => m.MyAccessRequests),
    canActivate: [authGuard]
  }, true ? { \u0275entryName: "src/access-request/my-request/my-requests.ts" } : {}),
  __spreadValues({
    path: "camunda/tasks",
    loadComponent: () => import("./chunk-KFIPFXQY.mjs").then((m) => m.PendingAccessTasks),
    canActivate: [authGuard, adminOrUserGuard]
  }, true ? { \u0275entryName: "src/access-request/pending-task/pending-tasks.ts" } : {}),
  {
    path: "",
    redirectTo: "home",
    pathMatch: "full"
...
var serverConfig = {
  providers: [provideServerRendering2(withRoutes(serverRoutes))]
};
