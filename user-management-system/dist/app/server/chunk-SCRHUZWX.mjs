...
import "./chunk-JFYBX7IY.mjs";
import {
  MatTooltip
} from "./chunk-JRH5C5AM.mjs";
import "./chunk-YMXW5W4M.mjs";
import {
...
function Register_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
...
function Register_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
...
var Register = class _Register {
  ...
  onSubmit() {
    if (this.registerForm.valid) {
      ...
      const formattedData = __spreadProps(__spreadValues({}, formValue), {
        dob: formValue.dob ? new Date(formValue.dob).toISOString().split("T")[0] : null
      });
      this.authService.register(formattedData).subscribe({
        next: () => {
          this.snackBar.open("Registration successful! Please login.", "Close", { duration: 3e3 });
          this.router.navigate(["/login"]);
        },
        error: (err) => {
          this.loading.set(false);
          this.snackBar.open(err.error?.message || "Registration failed. Please try again.", "Close", { duration: 5e3 });
        }
      });
    }
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Register, selectors: [["app-register"]], features: [\u0275\u0275ProvidersFeature([provideNativeDateAdapter()])], decls: 57, vars: 13, consts: [["picker", ""], [1, "flex", "min-h-[calc(100vh-120px)]", "items-center", "justify-center", "p-2", "sm:p-4"], [1, "w-full", "max-w-2xl", "rounded-3xl", "border", "border-slate-200/80", "bg-white/95", "p-5", "shadow-2xl", "sm:p-8"], [1, "flex", "flex-col", "items-center", "mb-6"], [1, "bg-accent/10", "p-4", "rounded-full", "mb-4"], ["color", "accent", 1, "scale-150"], [1, "text-2xl", "font-bold", "text-slate-800"], [1, "text-slate-500"], [1, "grid", "grid-cols-1", "gap-4", "md:grid-cols-2", 3, "ngSubmit", "formGroup"], ["appearance", "outline", 1, "w-full"], ["matInput", "", "formControlName", "username", "placeholder", "Choose a username"], ["matInput", "", "formControlName", "email", "type", "email", "placeholder", "Enter your email"], ["matInput", "", "formControlName", "password", "placeholder", "Create a password", 3, "type"], ["mat-icon-button", "", "matSuffix", "", "type", "button", 3, "click"], ["matInput", "", "formControlName", "firstName", "placeholder", "Enter your first name"], ["matInput", "", "formControlName", "lastName", "placeholder", "Enter your last name"], ["matInput", "", "formControlName", "dob", "placeholder", "Choose a date", 3, "matDatepicker"], ["matIconSuffix", "", 3, "for"], [1, "col-span-1", "mt-4", "flex", "flex-col", "gap-4", "md:col-span-2"], ["mat-flat-button", "", "color", "accent", 1, "w-full", "rounded-xl", "!bg-emerald-600", "py-4", "text-base", "font-semibold", "!text-white", "shadow-md", "transition", "hover:!bg-emerald-700", "disabled:!bg-slate-300", "disabled:!text-slate-500", 3, "disabled"], [1, "text-center", "text-slate-600"], ["routerLink", "/login", 1, "text-accent", "font-semibold", "hover:underline"]], template: function Register_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "mat-card-subtitle", 7);
      \u0275\u0275text(9, "Join us today! Fill in your information below.");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275conditionalCreate(15, Register_Conditional_15_Template, 2, 0, "mat-error");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "mat-form-field", 9)(17, "mat-label");
      \u0275\u0275text(18, "Email");
      \u0275\u0275elementEnd();
      \u0275\u0275element(19, "input", 11);
      \u0275\u0275conditionalCreate(20, Register_Conditional_20_Template, 2, 0, "mat-error")(21, Register_Conditional_21_Template, 2, 0, "mat-error");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function Register_Template_button_click_26_listener() {
        return ctx.hidePassword.set(!ctx.hidePassword());
      });
      \u0275\u0275elementStart(27, "mat-icon");
      \u0275\u0275text(28);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(29, Register_Conditional_29_Template, 2, 0, "mat-error")(30, Register_Conditional_30_Template, 2, 0, "mat-error");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275conditionalCreate(40, Register_Conditional_40_Template, 2, 0, "mat-error");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(41, "mat-form-field", 9)(42, "mat-label");
      \u0275\u0275text(43, "Date of Birth");
      \u0275\u0275elementEnd();
      \u0275\u0275element(44, "input", 16)(45, "mat-datepicker-toggle", 17)(46, "mat-datepicker", null, 0);
      \u0275\u0275conditionalCreate(48, Register_Conditional_48_Template, 2, 0, "mat-error");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(49, "div", 18)(50, "button", 19);
      \u0275\u0275conditionalCreate(51, Register_Conditional_51_Template, 1, 0)(52, Register_Conditional_52_Template, 1, 0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(53, "div", 20);
      \u0275\u0275text(54, " Already have an account? ");
    ...
    if (rf & 2) {
      ...
      let tmp_8_0;
      let tmp_11_0;
      const picker_r1 = \u0275\u0275reference(47);
      \u0275\u0275advance(10);
      \u0275\u0275property("formGroup", ctx.registerForm);
      \u0275\u0275advance(5);
      \u0275\u0275conditional(((tmp_2_0 = ctx.registerForm.get("username")) == null ? null : tmp_2_0.hasError("required")) ? 15 : -1);
      \u0275\u0275advance(5);
      \u0275\u0275conditional(((tmp_3_0 = ctx.registerForm.get("email")) == null ? null : tmp_3_0.hasError("required")) ? 20 : ((tmp_3_0 = ctx.registerForm.get("email")) == null ? null : tmp_3_0.hasError("email")) ? 21 : -1);
      \u0275\u0275advance(5);
      \u0275\u0275property("type", ctx.hidePassword() ? "password" : "text");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.hidePassword() ? "visibility_off" : "visibility");
      \u0275\u0275advance();
      \u0275\u0275conditional(((tmp_6_0 = ctx.registerForm.get("password")) == null ? null : tmp_6_0.hasError("required")) ? 29 : ((tmp_6_0 = ctx.registerForm.get("password")) == null ? null : tmp_6_0.hasError("minlength")) ? 30 : -1);
      \u0275\u0275advance(6);
      \u0275\u0275conditional(((tmp_7_0 = ctx.registerForm.get("firstName")) == null ? null : tmp_7_0.hasError("required")) ? 35 : -1);
      \u0275\u0275advance(5);
      \u0275\u0275conditional(((tmp_8_0 = ctx.registerForm.get("lastName")) == null ? null : tmp_8_0.hasError("required")) ? 40 : -1);
      \u0275\u0275advance(4);
      \u0275\u0275property("matDatepicker", picker_r1);
      \u0275\u0275advance();
      \u0275\u0275property("for", picker_r1);
      \u0275\u0275advance(3);
      \u0275\u0275conditional(((tmp_11_0 = ctx.registerForm.get("dob")) == null ? null : tmp_11_0.hasError("required")) ? 48 : -1);
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Register, [{
    type: Component,
    args: [{ selector: "app-register", standalone: true, providers: [provideNativeDateAdapter()], imports: [
      ReactiveFormsModule,
      RouterLink,
      MatCardModule,
      MatFormFieldModule,
  ...
  <mat-card class="w-full max-w-2xl rounded-3xl border border-slate-200/80 bg-white/95 p-5 shadow-2xl sm:p-8">
    <mat-card-header class="flex flex-col items-center mb-6">
      <div class="bg-accent/10 p-4 rounded-full mb-4">
        <mat-icon color="accent" class="scale-150">person_add</mat-icon>
      </div>
      <mat-card-title class="text-2xl font-bold text-slate-800">Create Account</mat-card-title>
      <mat-card-subtitle class="text-slate-500">Join us today! Fill in your information below.</mat-card-subtitle>
    </mat-card-header>
    
    <form [formGroup]="registerForm" (ngSubmit)="onSubmit()" class="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <mat-form-field appearance="outline" class="w-full">
        ...
        @if (registerForm.get('dob')?.hasError('required')) {
          <mat-error>Date of birth is required</mat-error>
        }
      </mat-form-field>

      <div class="col-span-1 mt-4 flex flex-col gap-4 md:col-span-2">
        <button
          mat-flat-button
          color="accent"
          class="w-full rounded-xl !bg-emerald-600 py-4 text-base font-semibold !text-white shadow-md transition hover:!bg-emerald-700 disabled:!bg-slate-300 disabled:!text-slate-500"
        ...
        <div class="text-center text-slate-600">
          ...
          <a routerLink="/login" class="text-accent font-semibold hover:underline">Sign in</a>
        </div>
      </div>
    </form>
  </mat-card>
</div>
`, styles: ["/* src/register/register.css */\n:host {\n  display: block;\n}\n/*# sourceMappingURL=register.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Register, { className: "Register", filePath: "src/register/register.ts", lineNumber: 32 });
})();
export {
  Register
};
//# sourceMappingURL=chunk-SCRHUZWX.mjs.map
